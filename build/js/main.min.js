...
require("./modules/mobile-menu/locomotive-scroll");
var _burger = require("./modules/mobile-menu/burger");
var _initLocomotiveScroll = require("./modules/mobile-menu/init-locomotive-scroll");
var _video = _interopRequireDefault(require("./modules/video/video"));
var _audio = _interopRequireDefault(require("./modules/audio/audio"));
var _map = _interopRequireDefault(require("./modules/map/map"));
...
},{"./modules/audio/audio":2,"./modules/form-validate/form":4,"./modules/map/map":10,"./modules/mobile-menu/burger":11,"./modules/mobile-menu/init-locomotive-scroll":13,"./modules/mobile-menu/locomotive-scroll":15,"./modules/video/video":17,"./utils/ios-vh-fix":19,"./vendor":20}],2:[function(require,module,exports){
"use strict";
...
var playBtn = document.querySelector('.player__btn--play');
var audio = document.querySelector('.player__audio');
var progressContainer = document.querySelector('.player__progress-container');
var progress = document.querySelector('.player__progress');
var title = document.querySelector('.player__song');
var imgBtn = document.querySelector('.player__btn--play img');
var currentDuration = document.querySelector('.player__duration-current');
var totalDuration = document.querySelector('.player__duration-total');
function initAudio() {
  if (!player) {
    return;
  }
  ...
  playBtn.addEventListener('click', function () {
    var isPlaying = player.classList.contains('play');
    if (isPlaying) {
      pauseSong();
    } else {
      playSong();
  ...
  function updateProgress(evt) {
    var _evt$srcElement = evt.srcElement,
      duration = _evt$srcElement.duration,
      currentTime = _evt$srcElement.currentTime;
...
exports.default = void 0;
var _leaflet = _interopRequireDefault(require("../../vendor/leaflet"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function initLeaflet() {
  _leaflet.default.Control.prototype._refocusOnMap = function _refocusOnMap(ev) {
  ...
  var map = new _leaflet.default.map('map', mapOptions);
  var layer = new _leaflet.default.TileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png');
  map.addLayer(layer);
  var iconOptions = {
  ...
  var marker = new _leaflet.default.Marker([55.774836, 37.632664], markerOptions);
  marker.addTo(map);
}
var _default = initLeaflet;
exports.default = _default;

},{"../../vendor/leaflet":21}],11:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":12,"./scroll-lock":16}],12:[function(require,module,exports){
"use strict";
...
function initVideo() {
  ...
  var videoPlay = document.querySelector('.hero__video-play');
  if (!(video || videoPlay)) {
    return;
  }
...
function initSliders() {
  ...
  var nextToursSlider = new Swiper('.next-tours__slider', {
    direction: 'horizontal',
    slidesPerView: 3,
    spaceBetween: 30,
    breakpoints: {
  ...
  var trainingSlider = new Swiper('.training__slider', {
    direction: 'horizontal',
    slidesPerView: 4,
    spaceBetween: 30,
    breakpoints: {
...
},{"./vendor/swiper":22}],21:[function(require,module,exports){
"use strict";
