...
},{"./modules/audio/audio":2,"./modules/form-validate/form":4,"./modules/map/map":10,"./modules/mobile-menu/burger":11,"./modules/sliders/sliders":12,"./modules/video/video":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
function initSliders() {
  ...
  var nextToursSlider = new _swiper.default('.next-tours__slider', {
    direction: 'horizontal',
    slidesPerView: 3,
    spaceBetween: 30,
    allowTouchMove: false,
  ...
  var trainingSlider = new _swiper.default('.training__slider', {
    direction: 'horizontal',
    slidesPerView: 4,
    spaceBetween: 30,
    allowTouchMove: false,
  ...
  function desktopAdvantagesSlider() {
    if (desktopWidth.matches && advantagesSlider.dataset.desktop === 'false') {
      advantagesSwiper = new _swiper.default('.advantages__slider', {
        direction: 'horizontal',
        slidesPerView: 3.6,
        spaceBetween: 30,
        allowTouchMove: false,
  ...
  var gallerySlider = new _swiper.default('.gallery__slider', {
    direction: 'horizontal',
    slidesPerView: 'auto',
    spaceBetween: 5,
    allowTouchMove: false,
